    ...
    this.container.addEventListener(
      ...
      () => {
        ...
        if (Math.abs(difference) > 50) {
          // Minimum de 50px pour déclencher le swipe
          if (difference > 0) {
            this.next();
          } else {
            this.prev();
...
const mapPoints = [
  {
    ...
    name: "Néo-Arcadia",
    description:
      "La capitale technologique, centre névralgique de la civilisation moderne.",
  },
  {
    x: 65,
    y: 45,
    ...
    description:
      "Une forêt mystique où la technologie des Anciens fusionne avec la nature.",
  },
  {
    x: 45,
    y: 75,
    ...
    description:
      "Vestiges d'une guerre antique, où rôdent des créatures mi-organiques, mi-machines.",
  },
];
